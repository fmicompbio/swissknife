...
- When adding code, bump the version number of the package in the DESCRIPTION file, add an entry in the `NEWS` file and to the `_pkgdown.yml` file (`reference` section), and re-run `pkgdown::build_site()` to update the pakcage overview page [https://fmicompbio.github.io/swissknife/](https://fmicompbio.github.io/swissknife/).
