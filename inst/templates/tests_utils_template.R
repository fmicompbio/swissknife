...
expect_error(.assertScalar(1, type = "numeric", xname = 1))
expect_error(.assertScalar(1, type = "numeric", xname = TRUE))
expect_error(.assertScalar(1, type = "numeric", xname = NULL))
expect_error(.assertScalar(1, type = "numeric", xname = c("a", "b")))
...
expect_error(.assertVector(1, type = "numeric", xname = 1))
expect_error(.assertVector(1, type = "numeric", xname = TRUE))
expect_error(.assertVector(1, type = "numeric", xname = NULL))
expect_error(.assertVector(1, type = "numeric", xname = c("a", "b")))
...
expect_error(.assertVector(c(1, 2), type = "numeric", validValues = c(1, 3), xname = "hello"))
